...
export default function ProjectDetails() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-16 px-6 space-y-8 bg-bse-100 rounded-xl shadow-md">
      {/* Swiper slider */}
        ...
        <div className="flex flex-wrap gap-4">
          ...
          {project.githubLink && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 text-base-content/80 hover:text-[#E63946] text-sm"
            >
      ...
      {project.futurePlan && (
        <div>
          ...
          <p className="text-base-content/80 leading-relaxed">{project.futurePlan}</p>
        </div>
      )}
      ...
      <div>
        <Link
          to="/#projects"
          className="inline-block mt-4 text-[#E63946] hover:text-base-content text-sm"
        >
          ← Back to Projects
        </Link>
      </div>
