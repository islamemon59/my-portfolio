...
const AboutMe = () => {
  ...
  return (
    <section
      id="about"
      className="px-4 py-20 md:py-24 md:px-16 text-black w-full bg-transparent overflow-hidden"
    >
      <motion.div
      ...
      >
        ...
        >
          ...
          passionate MERN Stack Developer from Bangladesh. I love crafting
          clean, responsive, and dynamic web applications with{" "}
        ...
        >
          ...
          . I love learning and exploring new tech every day.
        </motion.p>
        ...
        >
          Beyond code, I'm into tech trends, open source, and building ideas
          with creative teams. Let's make something awesome together!
        </motion.p>
      </motion.div>
    </section>
  );
