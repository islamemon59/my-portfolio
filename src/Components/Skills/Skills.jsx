...
export default function Skills() {
  ...
  return (
    <section
      id="skills"
      className="px-4 py-20 md:py-20 md:px-16 bg-transparent text-base-content overflow-hidden"
    >
      <motion.div
              ...
              >
                {category.skills.map((skill, index) => (
                  ...
                  >
                    ...
                    <div
                      className="absolute bottom-full mb-3 w-48 px-3 py-2 rounded-md text-sm text-base-100 bg-base-content bg-opacity-75
